...
const STEP_ICONS = [
  ...
  <path key="2" d="M4 8V5h3M20 8V5h-3M4 16v3h3M20 16v3h-3M8 12h8"></path>,
  (
    <>
...
export default function OcrPage() {
  ...
  const STEPS = [
    { n: "01", title: t("ocrPage.step1Title"), desc: t("ocrPage.step1Desc"), icon: STEP_ICONS[0] },
    { n: "02", title: t("ocrPage.step2Title"), desc: t("ocrPage.step2Desc"), icon: STEP_ICONS[1] },
    { n: "03", title: t("ocrPage.step3Title"), desc: t("ocrPage.step3Desc"), icon: STEP_ICONS[2] },
  ];
    ...
    <div>
      <section style={{ padding: "clamp(48px,6vw,88px) 24px 0" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 21.88, fontWeight: 500, color: "var(--cs-text-2)" }}>
          ...
          <span style={{ color: "var(--cs-line)" }}>/</span>
          <span style={{ color: "var(--cs-text)" }}>{t("ocr.name")}</span>
        </div>
