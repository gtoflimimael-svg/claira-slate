...
import { TypewriterHeadline } from "@/components/typewriter-text";
...
const TRUST = [
  { key: "trustNeverTraining", d: "M4 12.5l5 5L20 6.5" },
  { key: "trustDeletedAfterHour", d: "M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18zM12 7.5V12l3 2" },
  { key: "trustEuResidency", d: "M12 3l8 3v6c0 5-3.5 7.7-8 9-4.5-1.3-8-4-8-9V6z" },
];
    ...
    <div>
      ...
      >
        ...
        <div style={{ position: "relative", maxWidth: 1200, margin: "0 auto", padding: "calc(clamp(56px,8vw,112px) + 68px) 24px clamp(56px,7vw,96px)" }}>
          ...
          <TypewriterHeadline
            className="ai-typewriter-headline"
            style={{
              margin: "22px 0 0",
              maxWidth: 800,
          ...
          <div className="ai-cards-grid" style={{ marginTop: "clamp(44px,6vw,72px)" }}>
            {AI_CARDS.map((c, i) => (
              <Reveal key={c.key} variant="fade" index={i} style={{ height: "100%" }}>
                <Link href={c.href} className="ai-feature-card" style={{ height: "100%" }}>
