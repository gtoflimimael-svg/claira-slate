...
import { TranslateTool } from "@/components/ai/translate-tool";

export const metadata = {
  title: "Translate a PDF — Claira Slate",
  description: "Translate a document into 50+ languages while keeping its original layout and structure.",
};
...
const STEPS = [
  ...
  },
  {
    ...
    desc: "50+ languages, with formatting and paragraph breaks preserved.",
    icon: <path d="M4 6h9M8.5 6c0 5-2 8-5.5 10M6 11c1.5 3 4 4.5 7 5M13 20l4-10 4 10M14.6 17h4.8"></path>,
  },
  {
    n: "03",
    title: "Download the result",
    desc: "Get a translated PDF, or copy the plain text.",
    icon: (
      <>
    ...
    <div>
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "clamp(48px,6vw,88px) 24px 0" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12.5, fontWeight: 500, color: "var(--cs-text-2)" }}>
          ...
          <span style={{ color: "var(--cs-line)" }}>/</span>
          <span style={{ color: "var(--cs-text)" }}>Translate</span>
        </div>
        <div style={{ marginTop: "clamp(28px,3.5vw,44px)", display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 18 }}>
          ...
          <p style={{ margin: 0, maxWidth: 520, fontSize: "clamp(15px,1.4vw,18px)", lineHeight: 1.6, color: "var(--cs-text-2)", textWrap: "pretty" }}>
            Translate contracts, reports and decks into 50+ languages — paragraph breaks and structure stay intact.
          </p>
        </div>
      </section>
