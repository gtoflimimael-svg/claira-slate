...
const STEP_ICONS = [
  ...
  <path key="2" d="M4 6h9M8.5 6c0 5-2 8-5.5 10M6 11c1.5 3 4 4.5 7 5M13 20l4-10 4 10M14.6 17h4.8"></path>,
  (
    <>
...
const OTHER_AI = [
  ...
  { slug: "chat", href: "/ai/chat", icon: <path d="M21 14a3 3 0 0 1-3 3H8l-5 4V6a3 3 0 0 1 3-3h12a3 3 0 0 1 3 3z"></path> },
...
export default function TranslatePage() {
  ...
  const STEPS = [
    { n: "01", title: t("translatePage.step1Title"), desc: t("translatePage.step1Desc"), icon: STEP_ICONS[0] },
    { n: "02", title: t("translatePage.step2Title"), desc: t("translatePage.step2Desc"), icon: STEP_ICONS[1] },
    { n: "03", title: t("translatePage.step3Title"), desc: t("translatePage.step3Desc"), icon: STEP_ICONS[2] },
  ];
    ...
    <div>
      <section style={{ padding: "clamp(48px,6vw,88px) 24px 0" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 21.88, fontWeight: 500, color: "var(--cs-text-2)" }}>
          ...
          <span style={{ color: "var(--cs-line)" }}>/</span>
          <span style={{ color: "var(--cs-text)" }}>{t("translate.name")}</span>
        </div>
