...
const STEP_ICONS = [
  ...
  <path key="2" d="M13.5 2.5 4 14h6.5L9.5 21.5 20 10h-7z"></path>,
  (
    <>
...
export default function SummarizePage() {
  ...
  const STEPS = [
    { n: "01", title: t("summarizePage.step1Title"), desc: t("summarizePage.step1Desc"), icon: STEP_ICONS[0] },
    { n: "02", title: t("summarizePage.step2Title"), desc: t("summarizePage.step2Desc"), icon: STEP_ICONS[1] },
    { n: "03", title: t("summarizePage.step3Title"), desc: t("summarizePage.step3Desc"), icon: STEP_ICONS[2] },
  ];
    ...
    <div>
      <section style={{ padding: "clamp(48px,6vw,88px) 24px 0" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12.5, fontWeight: 500, color: "var(--cs-text-2)" }}>
          ...
          <span style={{ color: "var(--cs-line)" }}>/</span>
          <span style={{ color: "var(--cs-text)" }}>{t("summarize.name")}</span>
        </div>
