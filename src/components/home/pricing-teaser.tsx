  ...
  return (
    <section id="pricing" style={{ borderTop: "1px solid var(--cs-line)", background: "var(--cs-bg-2)" }}>
      <div style={{ padding: "clamp(64px,8vw,104px) 24px" }}>
        <Reveal as="h2" style={{ margin: 0, fontFamily: "var(--font-geist), Inter, sans-serif", fontWeight: 600, fontSize: "clamp(52.5px,7.7vw,84px)", lineHeight: 1.06, letterSpacing: "-.035em" }}>
          {tp("headline")}
        </Reveal>
        <p style={{ margin: "14px 0 0", maxWidth: 440, fontSize: 28, color: "var(--cs-text-2)" }}>{th("subhead")}</p>
        <div style={{ marginTop: "clamp(36px,5vw,52px)", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(268px,1fr))", gap: 14, alignItems: "start" }}>
          <Reveal variant="scale" index={0} data-lift style={{ padding: 26, border: "1px solid var(--cs-line)", borderRadius: 20, background: "var(--cs-card)" }}>
            <div style={{ fontSize: 24.5, fontWeight: 600, letterSpacing: "-.01em" }}>{tp("free.name")}</div>
            <div style={{ marginTop: 14, display: "flex", alignItems: "baseline", gap: 6 }}>
              <span style={{ fontFamily: "var(--font-geist), Inter, sans-serif", fontSize: 70, fontWeight: 600, letterSpacing: "-.04em" }}>$0</span>
              <span style={{ fontSize: 24.5, color: "var(--cs-text-2)" }}>{tp("free.unit")}</span>
            </div>
            ...
            <Link
              ...
              style={{ marginTop: 24, display: "block", textAlign: "center", padding: 11, borderRadius: 10, border: "1px solid var(--cs-line)", color: "var(--cs-text)", fontSize: 24.5, fontWeight: 500, cursor: "pointer" }}
            >
              {tp("free.cta")}
            </Link>
          </Reveal>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
              <div style={{ fontSize: 24.5, fontWeight: 600, letterSpacing: "-.01em", color: "var(--cs-accent)" }}>{tp("pro.name")}</div>
              <div style={{ padding: "4px 10px", borderRadius: 99, background: "var(--cs-grad)", color: "#fff", fontSize: 19.25, fontWeight: 600 }}>{tp("pro.badge")}</div>
            </div>
            <div style={{ marginTop: 14, display: "flex", alignItems: "baseline", gap: 6 }}>
              <span style={{ fontFamily: "var(--font-geist), Inter, sans-serif", fontSize: 70, fontWeight: 600, letterSpacing: "-.04em" }}>$5</span>
              <span style={{ fontSize: 24.5, color: "var(--cs-text-2)" }}>{tp("pro.unit")}</span>
            </div>
            <div style={{ marginTop: 22, display: "flex", flexDirection: "column", gap: 11 }}>
            ...
            <Link
              href="/signup"
              style={{ marginTop: 24, display: "block", textAlign: "center", padding: 11, borderRadius: 10, background: "var(--cs-accent)", color: "#fff", fontSize: 24.5, fontWeight: 500, cursor: "pointer" }}
            >
              {tp("pro.cta")}
            </Link>
          </Reveal>
          ...
          <Reveal variant="scale" index={2} data-lift style={{ padding: 26, border: "1px solid var(--cs-line)", borderRadius: 20, background: "var(--cs-card)" }}>
            <div style={{ fontSize: 24.5, fontWeight: 600, letterSpacing: "-.01em" }}>{tp("business.name")}</div>
            <div style={{ marginTop: 14, display: "flex", alignItems: "baseline", gap: 6 }}>
              <span style={{ fontFamily: "var(--font-geist), Inter, sans-serif", fontSize: 70, fontWeight: 600, letterSpacing: "-.04em" }}>$12</span>
              <span style={{ fontSize: 24.5, color: "var(--cs-text-2)" }}>{tp("business.unit")}</span>
            </div>
            <div style={{ marginTop: 22, display: "flex", flexDirection: "column", gap: 11 }}>
        ...
        <div style={{ marginTop: 30 }}>
          <Link href="/pricing" style={{ fontSize: 25.38, fontWeight: 500, cursor: "pointer" }}>
