          ...
          <div>
            <h1
              style={{
                ...
                fontWeight: 600,
                fontSize: "clamp(47.5px,7.5vw,90px)",
                lineHeight: 1.04,
                letterSpacing: "-.042em",
                textWrap: "balance",
              }}
            ...
            <p
              style={{
                margin: "24px 0 0",
                maxWidth: 520,
                fontSize: "clamp(20px,1.88vw,23.75px)",
                lineHeight: 1.6,
                color: "var(--cs-text-2)",
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 12, marginTop: 34, animation: "csRise .5s var(--cs-ease) 1.25s both" }}>
              ...
              >
                {t("ctaPrimary")} <span data-tip style={{ fontSize: 18.75 }}>&rarr;</span>
              </Link>
              <Link
                data-press
                href="/tools"
            ...
            <div style={{ margin: "22px 0 0", display: "flex", flexWrap: "wrap", alignItems: "center", gap: 16, fontSize: 16.88, fontWeight: 500, color: "var(--cs-text-2)" }}>
