...
const linkStyle = { cursor: "pointer", fontSize: 23.62, color: "var(--cs-text-2)" } as const;
const colTitleStyle = { fontSize: 21.88, fontWeight: 600, letterSpacing: ".02em", color: "var(--cs-text)" } as const;
const compactLinkStyle = { cursor: "pointer", fontSize: "1.4rem", color: "var(--cs-text-2)" } as const;
const compactColTitleStyle = { fontSize: "1.4rem", fontWeight: 600, letterSpacing: ".02em", color: "var(--cs-text)" } as const;
    ...
    <footer style={{ background: "var(--cs-bg)", borderTop: "1px solid var(--cs-line)", marginTop: compact ? 120 : 0 }}>
      ...
      >
        <div style={{ minWidth: 200 }}>
          ...
          <div style={{ marginTop: 12, fontSize: compact ? "1.4rem" : 24.5, color: "var(--cs-text-2)", maxWidth: 220 }}>{t("tagline")}</div>
        </div>
        <div>
      ...
      <div
        style={{
          ...
          fontSize: compact ? "1.31rem" : 21.88,
          color: "var(--cs-text-2)",
        }}
      >
